...
// Broadcaster defines how game events are delivered to connected clients.
type Broadcaster interface {
	Broadcast(roomCode string, msg GameMessage)
	SendToPlayer(roomCode string, playerID uuid.UUID, msg GameMessage)
}
...
// ChatMessage represents a chat message in a game (Domain)
