...
type User struct {
	...
	AuthType     domain.AuthType `json:"auth_type" gorm:"not null"`
...
type Player struct {
	...
	Type      domain.PlayerType `json:"type" gorm:"default:'human'"`
	AuthType  domain.AuthType   `json:"auth_type" gorm:"default:'guest'"`
...
type GameRound struct {
	...
	Status          domain.RoundStatus `json:"status" gorm:"default:'storytelling'"`
